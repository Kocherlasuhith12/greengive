...
// ✅ Move all the logic into a separate inner component
  ...
  return (
    <div className="max-w-2xl mx-auto py-10 space-y-6">
      <div>
        ...
        <p className="text-gray-400 mt-2">Choose your plan and continue to Stripe.</p>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <button
          ...
          className={`p-4 rounded-xl border text-left ${
            selectedPlan === 'monthly' ? 'border-pink-500 bg-pink-900/20' : 'border-dark-500 bg-dark-800'
          }`}
        >
        ...
        <button
          ...
          className={`p-4 rounded-xl border text-left ${
            selectedPlan === 'yearly' ? 'border-pink-500 bg-pink-900/20' : 'border-dark-500 bg-dark-800'
          }`}
        >
